...
namespace CC.Jift.Common
{
    ...
    public static class SaveImage
    {
        ...
        public static bool ByStringToSave(string name, string iss,int classid)
        {
            ...
            string studentimages = "StudentImage" + classid.ToString();

            if (Directory.Exists(@"./wwwroot/"+studentimages) == false)//如果不存在就创建file文件夹
            {
              Directory.CreateDirectory(@"./wwwroot/" + studentimages);
            }



            bmp.Save(@"./wwwroot/"+ studentimages + "/" + name + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            ms.Close();
            return true;
        }
        public static bool CreateZip(int classid)
        {
            string file_path = @"./wwwroot/StudentImage" + classid.ToString() + ".zip";
            string file_path2 = @"./wwwroot/StudentImage" + classid.ToString()+"/";
        ...
        {
            string file_path = @"./wwwroot/StudentImage" + classid.ToString() + "/";
